          ...
          <div className="mx-auto max-w-3xl space-y-14 text-slate-700 sm:space-y-16">
            ...
            <ContentSection title="Cruise passenger timing advice">
              ...
              <p className="leading-7">
                Read the{" "}
                <Link href={siteConfig.portGuidePath} className="content-link">
                  {siteConfig.portName} port guide
                </Link>
                , plan your day with our{" "}
                <Link href={siteConfig.oneDayPath} className="content-link">
                  one day in {siteConfig.portName}
                </Link>{" "}
          ...
          <section className="bg-surface-muted">
            <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Plan your {siteConfig.portName} port day
              </h2>
