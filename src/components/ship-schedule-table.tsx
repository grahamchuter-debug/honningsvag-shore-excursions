...
function compareValues(
  a: HonningsvagScheduleEntry,
  b: HonningsvagScheduleEntry,
  key: SortKey,
): number {
...
type ShipScheduleTableProps = {
  entries: HonningsvagScheduleEntry[];
};
    ...
    <div className="space-y-4">
      <label className="block">
        <span className="mb-2 block text-sm font-medium text-slate-700">
          Search Honningsvåg ship schedule
        </span>
        <input
          id="schedule-search"
          type="search"
          ...
          aria-label="Search Honningsvåg ship schedule"
