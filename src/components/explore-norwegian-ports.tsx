...
export const explorePortsFromHonningsvag: ExploreNorwegianPortsConfig = {
  intro: (
    <>
      If your itinerary includes more than one Norwegian port, plan each call
      around your ship&apos;s timetable before you sail. Many Arctic and coastal
      cruises pair Honningsvåg with{" "}
      <a
