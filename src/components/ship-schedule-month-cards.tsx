...
import {
  ...
  type getHonningsvagMonthSummaries,
} from "@/lib/honningsvag-schedules";

type MonthSummary = ReturnType<typeof getHonningsvagMonthSummaries>[number];
  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-sm leading-6 text-slate-500">
        ...
        {honningsvagScheduleIntegrity.lastDate
