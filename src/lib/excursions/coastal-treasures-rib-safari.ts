...
export const coastalTreasuresRibSafariExcursion: ExcursionData = {
  ...
  description: [
    ...
    "Operators commonly quote about 3 hours for arctic rib safari experiences, but you still need a confirmed return margin. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  ctaTitle: "Read the Coastal Treasures Arctic RIB Safari notes, then compare other options",
  ctaText:
