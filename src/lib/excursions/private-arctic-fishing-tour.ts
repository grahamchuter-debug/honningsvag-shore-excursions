...
export const privateArcticFishingTourExcursion: ExcursionData = {
  ...
  description: [
    ...
    "This tour fits the Approx. 3 hours window most guests expect for private arctic fishing experiences. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  ctaTitle: "Ready to book Private Arctic Fishing Tour?",
  ctaText:
