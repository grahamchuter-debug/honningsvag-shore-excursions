...
export const tasteOfTheArcticEbikeTourExcursion: ExcursionData = {
  ...
  description: [
    ...
    "Operators commonly quote about 2.5 to 3 hours for arctic e-bike tour experiences, but you still need a confirmed return margin. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  ctaTitle: "Read the Taste of the Arctic E-Bike Tour notes, then compare other options",
  ctaText:
