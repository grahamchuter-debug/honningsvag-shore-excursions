...
export const northCapeKingCrabExcursion: ExcursionData = {
  ...
  description: [
    ...
    "This tour fits the Approx. 3.5 hours window most guests expect for north cape & king crab experiences. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  ctaTitle: "Ready to book North Cape and King Crab Tour?",
  ctaText:
