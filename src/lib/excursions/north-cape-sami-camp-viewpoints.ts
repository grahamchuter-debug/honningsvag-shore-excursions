...
export const northCapeSamiCampViewpointsExcursion: ExcursionData = {
  slug: "north-cape-sami-camp-viewpoints",
  path: "/excursions/north-cape-sami-camp-viewpoints",
  title: "North Cape & Sami Camp",
  headline: "North Cape with Sami Camp and Viewpoints",
  lead: "Efficient North Cape touring with seasonal Sami camp, panoramic ocean viewpoints, and reindeer when available, approx. 3 hours, easy activity.",
  metaTitle: "North Cape with Sami Camp Shore Excursion",
  metaDescription:
    "North Cape tour with Sami camp and viewpoints from Honningsvåg. Reindeer when available, panoramic Arctic scenery, and easy pacing for cruise passengers.",
  heroImage: siteImages.northCapeSamiTour,
  heroImageAlt: imageAlts.northCapeSamiCard,
  summary: {
    ...
    bestFor:
      "Cruise passengers seeking north cape & sami camp experiences with clear return-to-ship planning",
  },
  snapshotCards: [
    ...
    { label: "Focus", value: "North Cape & Sami Camp" },
  ],
  gallery: [
  ...
  highlights: [
    "North Cape highlights",
    "Seasonal Sami camp experience",
    "Panoramic ocean viewpoint",
    "Reindeer when available",
    "Return-to-ship friendly coach timing",
  ],
  description: [
    "North Cape with Sami Camp and Viewpoints is designed for cruise passengers calling at Honningsvåg who want a structured Arctic day without guessing Magerøya drive times or meeting points. Operators usually coordinate departures near the harbour, but you still need a realistic buffer before all aboard.",
    ...
    "Operators commonly quote about 3 hours for north cape & sami camp experiences, but you still need a confirmed return margin. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  faqs: [
    {
      question: "How long is the North Cape with Sami Camp and Viewpoints?",
      answer:
  ...
  ctaTitle: "Read the North Cape with Sami Camp and Viewpoints notes, then compare other options",
  ctaText:
