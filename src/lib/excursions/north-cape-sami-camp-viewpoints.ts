...
export const northCapeSamiCampViewpointsExcursion: ExcursionData = {
  ...
  description: [
    ...
    "This tour fits the Approx. 3 hours window most guests expect for north cape & sami camp experiences. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  ctaTitle: "Ready to book North Cape with Sami Camp and Viewpoints?",
  ctaText:
