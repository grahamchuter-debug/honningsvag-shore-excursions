...
export const bruketNordvagenArcticVillageExcursion: ExcursionData = {
  ...
  description: [
    ...
    "Operators commonly quote about 2 hours for bruket nordvågen experiences, but you still need a confirmed return margin. Pair it with our port guide and one-day itinerary pages if you are planning a longer stay or a second call at Honningsvåg on a repositioning cruise.",
  ],
  included: [
  ...
  ctaTitle: "Read the Bruket Nordvågen Arctic Village Experience notes, then compare other options",
  ctaText:
