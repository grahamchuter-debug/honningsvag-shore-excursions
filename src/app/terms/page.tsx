...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Honningsvag Shore Excursions: independent cruise planning information for Honningsvåg port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Honningsvag Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Honningsvåg cruise day"
      ctaText="Explore North Cape options, bird safaris or village experiences, then verify timings with your cruise line."
      ctaHref="/excursions"
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Honningsvåg. It is not a substitute for official
      ...
      <section>
        ...
        <p>
          ...
          line. Hours ashore alone do not prove that a North Cape plateau day will
          fit.
        </p>
      </section>
